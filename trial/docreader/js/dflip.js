...
(function dFlip(DFLIP, $) {
  ...
  var defaults = DFLIP.defaults = {
    ...
    onCreate: function (flipBook) {
      ...
      //console.log("############# BaziReader #onCreate()=> ########## "+JSON.stringify(flipBook.type));
      //console.log("BaziReader #onCreate()=> "+JSON.stringify(flipBook));
    },
    onCreateUI: function (flipBook) {
      // after ui created event is fired
      //console.log("BaziReader #onCreateUI()=> "+JSON.stringify(flipBook));
    },
    onFlip: function (flipBook) {
      // after flip event is fired
      //console.log("BaziReader #onFlip()=> "+JSON.stringify(flipBook));
      //console.log("BaziReader #onFlip()=> "+JSON.stringify(flipBook.options.openPage));
      //alert("Page=> "+flipBook.page());
      //console.log("BaziReader #onCreate()=> "+JSON.stringify(flipBook));
    },
    beforeFlip: function (flipBook) {
      // before flip event is fired
      //console.log("BaziReader #beforeFlip()=> "+flipBook);
    },
    onReady: function (flipBook) {
      // after flip book is completely loaded
      //console.log("BaziReader #onReady()=> "+flipBook);
    },
  ...
  var createUI = function (container, object) {
      ...
      var prev = ui.prev = $(html.div, {
        ...
        object.prev();
         //alert("I am clicked at 847. Sorry for your inconvenience. We are doing a short test for your better experience.");
      });
      var play = $(html.div, {
